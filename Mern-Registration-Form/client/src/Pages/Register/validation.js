...
const RegistrationFormData = (inputValue, status, profile, getReferences) => {
    const { firstName, lastName, email, mobile, gender, address } = inputValue;
    const { firstNameRef, lastNameRef, emailRef, mobileRef, genderRef, addressRef, statusRef, profileRef } = getReferences;
